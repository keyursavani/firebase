  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Consumer<ProfileController>(builder: (context, provider, child) {
          return Container(
        ...
        children: [
          Container(
              ...
              child: provider.image == null
                  ? Image.network(
                      map['profileImg'].toString() == ""
                          ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1rTLeQraa9s-Rkj2_KMPOzh30CwK1G2D85A&usqp=CAU"
                          : map['profileImg'].toString(),
                      fit: BoxFit.cover,
                    )
                  : Stack(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          getDetailsWidget(
              title: "First Name",
              value: map['firstName'] != null && map['firstName'] != ""
                  ? map['firstName']
                  : "-",
              iconData: (Icons.edit),
              onPressed: () {
          ...
          getDetailsWidget(
              title: "Last Name",
              value: map['lastName'] != null && map['lastName'] != ""
                  ? map['lastName']
                  : "-",
              iconData: (Icons.edit),
              onPressed: () {
          ...
          getDetailsWidget(
              title: "Email",
              value: map['email'] != null && map['email'] != ""
                  ? map['email']
                  : "-"),
        ],
      ),
